...
import { useContractInteractor, getRandomInt } from "../../utils";
                            ...
                            <div className="text-left mt-[25px]">
                                ...
                                <div className="flex space-x-[20px] my-[5px] items-center">
                                    ...
                                    <div className="flex-initial w-80">
                                        <input className="bg-[#F5F5F5] rounded-full w-full py-[5px] px-[15px]" defaultValue={"brarandronik.testnet"} placeholder="petya.near" />
                                    </div>
