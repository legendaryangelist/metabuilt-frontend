            ...
            <div className="px-[80px] py-[40px]">
                <div className="flex space-x-[50px]">
                    <label className="flex cursor-pointer flex-col w-[125px] h-[125px] rounded-full border-none bg-white hover:bg-gray-100 relative">
                        ...
                        {selectedCommunityImg && <Image src={previewCommunityImg!} className="w-full h-full absolute rounded-full" width={100} height={100} alt="image" />}
                    </label>
                    ...
                    <div className="flex-initial w-[500px] text-left">
                        ...
                        <div className="flex items-center space-x-[20px] my-[10px]">
                            ...
                            <div className="flex-initial w-80">
                                <input className="bg-[#F5F5F5] rounded-full w-full py-[8px] px-[20px]" placeholder="add text" />
                            </div>
                        </div>
                        ...
                        <div className="flex space-x-[20px] my-[10px]">
                            ...
                            <div className="flex-initial w-80">
                                <textarea className="bg-[#F5F5F5] rounded-[10px] w-full py-[5px] px-[15px]" rows={3} />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    isCreateBadge && (
                        <div className="flex space-x-[50px]">
                            <label className="flex cursor-pointer flex-col w-[125px] h-[125px] rounded-full border-none bg-white hover:bg-gray-100 relative">
                                ...
                                <input type="file" className="opacity-0" onChange={onSelectBadgeImage} />
                                {selectedBadgeImg && <Image src={previewBadgeImg!} className="w-full h-full absolute rounded-full" width={100} height={100} alt="image" />}
                            </label>
                ...
                <button className="bg-[#3D3D3D] text-white rounded-full px-[20px] py-[5px] mt-[50px]">Create community</button>
            </div>
        </div>
    );
});
